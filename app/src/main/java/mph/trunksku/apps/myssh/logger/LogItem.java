...
public class LogItem implements Parcelable {
    ...
    VPNLog.LogLevel mLevel = VPNLog.LogLevel.INFO;
    ...
    public LogItem(VPNLog.LogLevel level, int verblevel, String message) {
        mMessage = message;
        mLevel = level;
    ...
    public LogItem(byte[] in, int length) throws UnsupportedEncodingException {
        ...
        mLevel = VPNLog.LogLevel.getEnumByValue(bb.getInt());
    ...
    public LogItem(Parcel in) {
        ...
        mLevel = VPNLog.LogLevel.getEnumByValue(in.readInt());
        mVerbosityLevel = in.readInt();
        logtime = in.readLong();
    }

    public LogItem(VPNLog.LogLevel loglevel, int ressourceId, Object... args) {
        mRessourceId = ressourceId;
        mArgs = args;
        mLevel = loglevel;
    }

    public LogItem(VPNLog.LogLevel loglevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
    }

    public LogItem(VPNLog.LogLevel loglevel, int ressourceId) {
        mRessourceId = ressourceId;
        mLevel = loglevel;
    }
        ...
        if (mArgs == null || mArgs.length == 0) {
            ...
            for (Object o : mArgs) {
                if (o instanceof String) {
                    ...
                    VPNLog.logDebug("Unknown object for LogItem marschaling " + o);
                    bb.putChar('s');
