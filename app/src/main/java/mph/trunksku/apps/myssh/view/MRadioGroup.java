...
public class MRadioGroup extends LinearLayout {
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(MRadioGroup group, @IdRes int checkedId);
    }
    ...
    public MRadioGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MRadioGroup(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setOnCheckedChangeListener(MRadioGroup.OnCheckedChangeListener listener) {
