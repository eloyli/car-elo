...
public class EasyFlipView extends FrameLayout {
  ...
  private int animFlipHorizontalOutId = R.anim.animation_horizontal_flip_out;
  private int animFlipHorizontalInId = R.anim.animation_horizontal_flip_in;
  private int animFlipHorizontalRightOutId = R.anim.animation_horizontal_right_out;
  private int animFlipHorizontalRightInId = R.anim.animation_horizontal_right_in;
  private int animFlipVerticalOutId = R.anim.animation_vertical_flip_out;
  private int animFlipVerticalInId = R.anim.animation_vertical_flip_in;
  private int animFlipVerticalFrontOutId = R.anim.animation_vertical_front_out;
  private int animFlipVerticalFrontInId = R.anim.animation_vertical_front_in;
  ...
  public void letFlip(int flip) {
	  if(flip == 0) {
		  ...
		  if(mFlipState == FlipState.BACK_SIDE) {
		  mSetTopOut.setTarget(mCardBackLayout);
		  mSetBottomIn.setTarget(mCardFrontLayout);
		  mSetTopOut.start();
		  mSetBottomIn.start();
