...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int itemContentWight = (int) getResources().getDimension(R.dimen.item_content_width);
	...
	private RelativeLayout centreContent;
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.drawable.ic_paper_plane);
    ...
    private void initAndAddViewsToMainView() {
		...
		centreContent = new RelativeLayout(context);
